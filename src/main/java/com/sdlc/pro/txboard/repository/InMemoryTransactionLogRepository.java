...
public final class InMemoryTransactionLogRepository implements TransactionLogRepository, InitializingBean {
    ...
    private void updateTransactionSummary(TransactionLog transactionLog) {
        this.summaryAtomicReference.updateAndGet(summary -> {
            ...
            long connectionAcquisitionCount = summary.getConnectionAcquisitionCount() + connectionSummary.getAcquisitionCount();
            long totalConnectionOccupiedTime = summary.getTotalConnectionOccupiedTime() + connectionSummary.getOccupiedTime();
            long alarmingConnectionCount = summary.getAlarmingConnectionCount() + connectionSummary.getAlarmingConnectionCount();
